...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Mahasiswa Status Magang</h1>
            ...
            <div class="table-responsive-lg">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <?php
                        $no = 1;
                        foreach ($mahasiswamagang as $data) {
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if ($data['statuspengajuan'] == 1) {
                                        echo '<a href="detail-pengajuan.php?id=' . $data['nopengajuan'] . '" class="btn btn-sm btn-info">Magang</a>';
                                    }
                                    ?>
                                </td>
                                <td class="text-center">
